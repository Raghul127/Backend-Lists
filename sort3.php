...
$sql = "SELECT id,list,checked,implev FROM list WHERE username='$username' ORDER BY checked ASC,implev DESC";
$result = $conn->query($sql);
?>
<p><strong>SORTED MY TO-DO-LIST BASED ON COMPLETION STATUS AND IMP LEVEL</strong></p>
<br>
